 ...
 */
Option.default = Option.tablePreferStyleAttributes;

var Module = {
  _convert: function(md, opt, noTagFilter) {
    if (typeof md !== 'string') {
    ...
    var resBuffer = _cmark_gfm_markdown_to_html(buffer, len, opt, noTagFilter);
...
Module.convert = function(md, opt) {
  return Module._convert(md, opt, false);
}
Module.convertUnsafe = function(md, opt) {
  return Module._convert(md, opt, true);
}
